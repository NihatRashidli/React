...
export default function Navbar() {
  ...
  return (
    <Box
      sx={{ flexGrow: 1 }}
      style={{ marginBottom: "20px", borderBottom: "1px solid #27314226" }}
    >
          ...
          <div className="userProfile">
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              ...
              >
                ...
                />
                <p style={{ marginLeft: "10px", fontSize: 20 }}> Wishlist</p>
              </IconButton>
              <IconButton
                size="large"
              ...
              >
                ...
                <p style={{ marginLeft: "13px", fontSize: 20 }}> Basket</p>
              </IconButton>
            </Box>
